...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "bundler", ">= 2.4", "< 5.0.0"
  spec.add_dependency "commonmarker", "~> 2.3"
  spec.add_dependency "docker_registry2", "~> 1.19"
  spec.add_dependency "excon", "~> 1.2"
  spec.add_dependency "faraday", "~> 2.7"
  spec.add_dependency "faraday-retry", "~> 2.2"
  spec.add_dependency "gitlab", "~> 6.0"
  spec.add_dependency "json", "< 2.22"
  spec.add_dependency "nokogiri", "~> 1.8"
  spec.add_dependency "octokit", "~> 10.0"
  spec.add_dependency "opentelemetry-api", "~> 1.9"
  spec.add_dependency "opentelemetry-logs-api", "~> 0.3"
  spec.add_dependency "opentelemetry-metrics-api", "~> 0.5"
